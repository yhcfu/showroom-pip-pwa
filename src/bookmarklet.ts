export function buildBookmarklet(playerBase: string): string {
  ...
  const isLocalDevelopment = target.hostname === "localhost" || target.hostname === "127.0.0.1";
